...
- You can also look into the already generated EDA report using dataprep called `eda_report.html`. If you want to generate your own dataprep EDA report, run the script `dataprep_script.py`.
